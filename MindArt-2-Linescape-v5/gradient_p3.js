...
function restart() {
  ...
  newLayer = createGraphics(windowWidth, windowHeight);
    newLayer2 = createGraphics(windowWidth, windowHeight);
...
function render() {
  intermedia.clear();
    intermedia.blendMode(ADD);
  intermedia.image(newLayer, 0, 0, width, height);
  intermedia.image(newLayer2, 0, 0, width, height);
