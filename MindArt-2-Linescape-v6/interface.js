let resetButton, saveButton, newTextureButton, fsButton, toggleBut;
...
$(".select").remove();
  ...
  resetButton.mousePressed(restart);
    ...
    newTextureButton = createButton('New Texture');
    newTextureButton.position(windowWidth - (10 * vMax) - (vMax * 5), windowHeight - vMax * 6);
    newTextureButton.class("select");
    newTextureButton.style('font-size', '1.7vmax');
    newTextureButton.style('height', '5vmax');
    newTextureButton.position(width - (16 * vMax), height - (13 * vMax));
    newTextureButton.mousePressed(shift);

  saveButton = createButton("Save")
  saveButton.class("select");
  saveButton.style('font-size', '1.7vmax');
  saveButton.style('height', '5vmax');
  saveButton.position(width - (16 * vMax), height - (20 * vMax));
